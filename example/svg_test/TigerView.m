...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        NSString* filePath =
            [[NSBundle mainBundle] pathForResource:@"tiger" ofType:@"js"];
        _tigerPathes =
...
- (void)drawRect:(CGRect)rect
{
    ...
    NSRegularExpression* pathesRegex =
    ...
    for (NSTextCheckingResult *result in matches) {
        ...
        NSString* path =
        [pathObject substringWithRange:[pathObject rangeOfString:@"path:\".*?\""
        ...
        NSString* stroke =
            [pathObject substringWithRange:[pathObject rangeOfString:@"stroke:\".*?\""
                                                             options:NSRegularExpressionSearch]];
        ...
        NSString* fill =
            [pathObject substringWithRange:[pathObject rangeOfString:@"fill:\".*?\""
                                                             options:NSRegularExpressionSearch]];
